...
describe('blogs', () => {
    ...
    it('should create blog', async () => {
        const {statusCode, body} = await agent.post('/blogs').set("Authorization", "Basic YWRtaW46cXdlcnR5")
            .send({
                "name": "qwertyqqq",
...
describe('blog create and update', () => {
    ...
    it('should create a post', async () =>  {
        const {statusCode, body} = await agent.post('/posts').set("Authorization", "Basic YWRtaW46cXdlcnR5")
            .send({
                "title": "TestPost",
    ...
    it('should update the blog', async () =>  {
        const {statusCode} = await agent.put(`/blogs/${id_test}`).set("Authorization", "Basic YWRtaW46cXdlcnR5")
            .send({
                "name": "TestUp",
                "description": "test",
                "websiteUrl": "test.com"
    ...
    it('should return posts with updated blogName', async () =>  {
        const {statusCode, body} = await agent.get(`/blogs/${id_test}/posts?sortDirection=asc`);
